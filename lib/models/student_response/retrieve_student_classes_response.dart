class RetrieveStudentClassesResponse {
  final bool success;
  final List<ClassData>? data;
  final int statusCode;
  final String? error;

  RetrieveStudentClassesResponse({
  ...
  factory RetrieveStudentClassesResponse.fromJson(Map<String, dynamic> json) {
    return RetrieveStudentClassesResponse(
...
class ClassData {
  ...
  factory ClassData.fromJson(Map<String, dynamic> json) {
    ...
    print('Formatted group number: $formattedGroupNum');
